        ...
        <div className="card m-3 text-start" style={{width: "18rem"}}>
            ...
            <div className="card-body">
                <h5 className="card-title">{props.name}</h5>
                    ...
                    <p className="card-text mb-0">Gender: {props.gender}</p>
                    <p className="card-text mb-0">Hair Color: {props.hair_color}</p>
                    <p className="card-text mb-0">Eye-Color: {props.eye_color}</p>
      
                <div className="row justify-content-between mt-4">
                    <div className="col-8">
                        <Link className="btn btn-primary" to={"/characterinfo/" + props.uid}>
